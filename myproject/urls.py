...
from . import views
from .views import ProfileUpdateView, PortfolioUpdateView, PortfolioItemPostView, PortfolioItemUpdateView, PortfolioDeleteView
...
urlpatterns = [
    ...
    path('portfolios/add/<str:username>', view=views.add_portfolios, name='add_portfolios'),
    ...
    path('portfolios/<str:username>/<str:portfolioId>/delete', PortfolioDeleteView.as_view(), name='delete_portfolio'),
